...
<html>
  <head>  
    ...
    App.factory('UserService', ['$http', '$q', function($http, $q){
        ...
        var REST_SERVICE_URI = 'http://localhost:8780/SpringMVCHibernate/user/';
                  ...
                  <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
                      ...
                      <div class="row">
                          <div class="form-group col-md-12">
                              ...
                              <div class="col-md-7">
                                  <input type="password" ng-model="ctrl.user.password" class="form-control input-sm" placeholder="Enter your Country [This field is validation free]"/>
                              </div>
                          </div>
                      </div>
                      ...
                      <div class="row">
                          <div class="form-group col-md-12">
                              <label class="col-md-2 control-lable" for="file">Card</label>
                              <div class="col-md-7">
                                  <input type="text" ng-model="ctrl.user.card" name="email" class="email form-control input-sm" placeholder="Enter your Card Number" required/>
                                  <div class="has-error" ng-show="myForm.$dirty">
                                      <span ng-show="myForm.card.$error.required">This is a required field</span>
                                      <span ng-show="myForm.card.$invalid">This field is invalid </span>
                                  </div>
                              </div>
                          </div>
                      </div>
                  ...
                  <table class="table table-hover">
                      ...
                      <tbody>
                          <tr ng-repeat="u in ctrl.users">
                              ...
                              <td><span ng-bind="u.card"></span></td>
